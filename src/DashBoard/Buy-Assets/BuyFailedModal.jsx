          ...
          subTitle={
            <div className="text-[white] largeDevice:text-[black]">
              <p>
                ...
                {selectedCrypto ? selectedCrypto.name : ""} was not successful.{" "}
                Amount to purchase must be at least 50 USD
              </p>
              ...
              >
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="uppercase text-center font-[600] text-white">
                    <p>
                      {selectedCrypto ? selectedCrypto.symbol : ""} Purchase
                      Failed
                    </p>
