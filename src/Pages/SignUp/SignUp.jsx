...
const SignUp = () => {
  ...
  return (
    <section className="bg-[rgb(28,33,39)] text-[white] h-[100%]">
              ...
              <div>
                <div className="mb-[30px]">
                  ...
                  <p className="text-[rgb(157,166,177)] font-[600] pr-[50px] smallerDevice:pr-[0]">
                    We’ll need you to choose a really cool name that other users
                    can find you with, choose something cool like aquaman, or
                    deadpool 😜
                  </p>
                </div>
